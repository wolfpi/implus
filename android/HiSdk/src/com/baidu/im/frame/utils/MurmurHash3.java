 ...
 * <p>
 * Note - The x86 and x64 versions do _not_ produce the same results, as the algorithms are optimized for their
...
public final class MurmurHash3 {
    ...
    public static int murmurhash3_x86_32(CharSequence data) {
        ...
        int len = data.length();
        int seed = 0;
        return murmurhash3_x86_32(data, offset, len, seed);
    }
    ...
    public static int murmurhash3_x86_32(CharSequence data, int offset, int len, int seed) {
        ...
        while (pos < end) {
            ...
            if (code < 0x80) {
                 ...
                 * << 24); k1 *= c1; k1 = (k1 << 15) | (k1 >>> 17); // ROTL32(k1,15); k1 *= c2; h1 ^= k1; h1 = (h1 <<
                 * 13) | (h1 >>> 19); // ROTL32(h1,13); h1 = h1*5+0xe6546b64; shift = 0; nBytes += 4; k1 = 0; } else {
                ...
                k2 =
                        (0xff & (0xF0 | (utf32 >> 18))) | ((0x80 | ((utf32 >> 12) & 0x3F))) << 8
