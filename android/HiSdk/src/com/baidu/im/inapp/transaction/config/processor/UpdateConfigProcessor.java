...
/*
public class UpdateConfigProcessor extends ConfigBaseProcessor {
    ...
    @Override
    public ProcessorResult startWorkFlow() throws IOException {
        return super.updateConfig();
    }
}*/
import java.util.List;

public class UpdateConfigProcessor  implements MessageResponser,ProcessorStart{
    ...
    public UpdateConfigProcessor(PreferenceUtil pref)
    {
    	// mPref = pref;
    }
