...
public class IMQueryMsgsProcessor implements IMProcessorStart {

    private String tag = "IMQueryMsgsProcessor";
    private QueryMsgsRequest queryMsgs;
    private QueryMsgsResponse response;
    private QueryMsgCallback mCallback = null;

    public IMQueryMsgsProcessor(String tag, QueryMsgsRequest queryMsgs, QueryMsgCallback callback) {
        this.tag = tag;
